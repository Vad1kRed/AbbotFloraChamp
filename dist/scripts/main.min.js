...
var childrenText = document.querySelectorAll('.children__text');
var adultsText = document.querySelectorAll('.adults__text');
var childrenBrand = document.querySelector('.children__brand');
var adultsBrand = document.querySelector('.adults__brand');
childrenText.forEach(function (item) {
...
adultsText.forEach(function (item) {
  item.addEventListener('click', function () {
    adultsText.forEach(function (item) {
      item.classList.remove('desc__text--active');
    });
